...
def tune_blocks(data_file,
	...
	fd = open('block_tuning_results_' + scenario + '_' + case + '.json', 'w')
...
if __name__ == '__main__':
	...
	fd = open('tuned_blocks_hyper_parameters_' + args.scenario + '_' + args.case + '.json', 'w')
