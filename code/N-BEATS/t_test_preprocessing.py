...
for s in ['carbs', 'bolus']:
	...
	if s == 'carbs':
		yes_no_added_no_p_rmse = stats.ttest_rel(yes_no_added_rmse, no_rmse, alternative='less').pvalue
		yes_no_added_no_p_mae = stats.ttest_rel(yes_no_added_mae, no_mae, alternative='less').pvalue
	
	p_values[s]['yes_no'] = {'RMSE': yes_no_p_rmse, 'MAE': yes_no_p_mae}
	if s == 'carbs':
		p_values[s]['yes_wo_imputed_meals_no'] = {'RMSE': yes_no_added_no_p_rmse, 'MAE': yes_no_added_no_p_mae}
