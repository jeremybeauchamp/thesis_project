...
for s in ['carbs', 'bolus', 'combo', 'carbs_wo_bolus']:
	...
	nbeats_lstm_p_rmse = stats.ttest_rel(nbeats_rmse, lstm_rmse, alternative='less').pvalue
	nbeats_global_p_rmse = stats.ttest_rel(nbeats_rmse, global_rmse, alternative='less').pvalue
	nbeats_time_p_rmse = stats.ttest_rel(nbeats_rmse, time_rmse, alternative='less').pvalue
	
	nbeats_lstm_p_mae = stats.ttest_rel(nbeats_mae, lstm_mae, alternative='less').pvalue
	nbeats_global_p_mae = stats.ttest_rel(nbeats_mae, global_mae, alternative='less').pvalue
	...
	p_values[s]['nbeats_global'] = {'RMSE': nbeats_global_p_rmse, 'MAE': nbeats_global_p_mae}
